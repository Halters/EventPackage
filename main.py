...
store.store_event(at=datetime.now(), data="Event number %d." % i)
...
for event in store.get_events(start=datetime.datetime(year=2018, month=1, day=1),end=datetime.datetime(year=2018, month=2, day=1)):
    print(event) """